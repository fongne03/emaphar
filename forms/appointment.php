<?php
  ...
  */
  ...
  $receiving_email_address = 'php20033@gmail.com';
  ...
  $contact->smtp = array(
    'host'       => 'smtp.gmail.com',
    'username'   => 'phamhaiphong31@gmail.com', // your Gmail address
    'password'   => 'jqcn axbv qwwb yzor',   // if using 2FA, use an app password here
    'port'       => '465',
    'encryption' => 'ssl'
  );
